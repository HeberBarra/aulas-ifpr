...
public class Main  {
    ...
    public static final int PESQUISAR_NOME = 4;
    public static final int PESQUISAR_CPF = 5;
    public static final int ATUALIZAR_USUARIO = 6;
    public static final int EXCLUIR_USUARIO = 7;
    ...
    public void executar() {
        while (true) {
            ...
            if (escolha == ADICIONAR_USUARIO) {
                ...
                pesquisarId();
            } else if (escolha == PESQUISAR_NOME) {
                pesquisarNome();
            } else if (escolha == PESQUISAR_CPF) {
                pesquisarCpf();
    ...
    public void pesquisarNome() {
        String nome = console.readLine("Digite o nome do usuário a ser pesquisado: ");

        mostrarInformacoes(gerenciarUsuario.searchByName(nome));
    }

    public void pesquisarCpf() {
        long cpf = console.readLong("Digite o cpf do usuário a ser pesquisado: ");

        Usuario usuario = gerenciarUsuario.findByCpf(cpf);
    ...
    public void mostrarMenu() {
        ...
        System.out.printf("[%d] Pesquisar por nome%n", PESQUISAR_NOME);
        System.out.printf("[%d] Pesquisar por cpf%n", PESQUISAR_CPF);
